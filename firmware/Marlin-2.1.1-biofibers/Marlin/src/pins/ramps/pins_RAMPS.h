...
#endif
#ifndef Z_CS_PIN
  #define Z_CS_PIN                            57 // mrivera: was 40 
#endif
...
#endif
#ifndef E0_CS_PIN
  #define E0_CS_PIN                           58 // mrivera: was 42
#endif
...
//
  ...
  // SPINDLE PINS (overrides defaults in pins_RAMPS.h)
  // set default pins for marlin to behave and know we have a spindle 
  #if ENABLED(ENABLE_BF_SPINDLE)
    #define SPINDLE_LASER_ENA_PIN   BF_SPINDLE_DRIVER_STBY_PIN  
    #define SPINDLE_LASER_PWM_PIN   BF_SPINDLE_DRIVER_PWM_A_PIN  
    #define SPINDLE_DIR_PIN         BF_SPINDLE_DRIVER_AIN1_PIN
  #elif NUM_SERVOS < 2                              // Use servo connector if possible

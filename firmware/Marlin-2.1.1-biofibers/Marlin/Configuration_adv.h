...
#include "BiofibersConfiguration.h"
...
// TODO (mrivera): Test smaller planner speed to enable slow movements
#define MINIMUM_PLANNER_SPEED 0.02 // (mm/s)
...
//#define LASER_FEATURE
  ...
  #if ENABLED(BF_SPINDLE_USE_PWM)
    #define SPINDLE_LASER_USE_PWM  // Enable if your controller supports setting the speed/power
  #endif

  #if ENABLED(SPINDLE_LASER_USE_PWM)
    #define SPINDLE_LASER_PWM_INVERT    false  // Set to "true" if the speed/power goes up when you want it to go slower
    #define SPINDLE_LASER_FREQUENCY     BF_SPINDLE_FREQUENCY   // (Hz) Spindle/laser frequency (only on supported HALs: AVR, ESP32, and LPC)
   ...
   *  - SERVO   (S0 - S180)
   */
  #define CUTTER_POWER_UNIT BF_SPINDLE_POWER_UNIT
  ...
  //#define CUTTER_POWER_RELATIVE              // Set speed proportional to [SPEED_POWER_MIN...SPEED_POWER_MAX]
    ...
    #define SPINDLE_CHANGE_DIR          BF_SPINDLE_DRIVER_CHANGE_DIR     // Enable if your spindle controller can change spindle direction
    #define SPINDLE_CHANGE_DIR_STOP     BF_SPINDLE_DRIVER_CHANGE_DIR_STOP       // Enable if the spindle should stop before changing spin direction
    #define SPINDLE_INVERT_DIR          BF_SPINDLE_DRIVER_INVERT_DIR  // Set to "true" if the spin direction is reversed

    #define SPINDLE_LASER_POWERUP_DELAY   BF_SPINDLE_DRIVER_POWERON_DELAY // (ms) Delay to allow the spindle/laser to come up to speed/power
    #define SPINDLE_LASER_POWERDOWN_DELAY BF_SPINDLE_DRIVER_POWEROFF_DELAY // (ms) Delay to allow the spindle to stop
     ...
     */
      ...
      #define SPEED_POWER_MIN         BF_SPINDLE_SPEED_RPM_MIN    // (RPM); orig 5000
      #define SPEED_POWER_MAX         BF_SPINDLE_SPEED_RPM_MAX    // (RPM) ; orig 30000 with SuperPID router controller 0 - 30,000 RPM
      #define SPEED_POWER_STARTUP     1    // (RPM) M3/M4 speed/power default (with no arguments)
    #endif
